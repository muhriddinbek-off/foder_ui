...
class BottomOrderWidget extends StatelessWidget {
  ...
  const BottomOrderWidget({super.key, required this.function});
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Text('Please order', style: AppStyle.getTextSmall().copyWith(color: AppColor.whiteColor, fontSize: 16.w, fontWeight: FontWeight.w500)),
